...
<!-- <body> -->
    ...
    <!-- <nav>
        <div class="container nav_container">
            ...
            <ul class="nav_items">
                <li><a href="../blog.php" class="nav_logo">Blog</a></li>
                <li><a href="../index.php" class="nav_logo">About</a></li>
                <li><a href="../index.php" class="nav_logo">Services</a></li>
                <li><a href="../index.php" class="nav_logo">Contact</a></li>

    ...
    <section class="posts">
        <div class="container posts_container">
            <article class="post">
                ...
                <div class="post_info">
                    <a href="#" class="category_button">Wild Category</a>
                    <h3 class="post_title"><a href="#" class="post.html">Lorem Ipsum, dolor sit amet aliquid consecutor</a></h3>
                    <p class="post_body">
